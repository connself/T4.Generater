...
namespace T4
{
    public class Config
    {
        ...
        public static readonly string DbDatabase = "mytest";
        public static readonly string Uid = "mytest";
        public static readonly string Pwd = "123456";
        //数据库类型
        public static readonly string DbType = "MySql";//MsSql\MySql

        //数据库连接	
        public static readonly string ConnectionString = string.Format("server={0};database={1};uid={2};pwd={3};character set=utf8;", Server, DbDatabase, Uid, Pwd);
        //命名空间
